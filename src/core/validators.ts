...
export function validateAgentSkillsFrontmatter(frontmatter: Record<string, unknown>): {
  valid: boolean;
  errors: string[];
} {
...
export function validateUnifiedSkill(skill: Record<string, unknown>): {
  valid: boolean;
  errors: string[];
} {
...
export function validateGeminiCommand(toml: Record<string, unknown>): GeminiCommandValidation {
